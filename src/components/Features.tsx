    ...
    <div className="py-4 text-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-[#FF80A0]">
            Free and Secure
          </h2>
          ...
          <dl className="grid max-w-xl grid-cols-1 gap-x-2 gap-y-2 lg:max-w-none lg:grid-cols-2 ">
            ...
            <div className="relative pl-16">
              <dt className="text-base font-semibold leading-7 text-gray-50">
                <div className="absolute left-0 top-2 flex h-10 w-10 items-center justify-center rounded-lg bg-dining">
